...
public class StepDefinition {
	...
	public void start_a_new_game() throws Exception {
	...
	public void it_is_your_turn_and_press_the_roll_button() throws Exception {
		 class GameScreen implements MouseListener {
...
public void the_players_turn_should_change() throws Exception {

	final GameScreen window = new GameScreen();

	System.out.println(window.getLabel());
